...
class Simulator():
    ...
    def trans(self, tstep, tstop, start=None, stop=None, uic=False):
        ...
        # allocate the output arrays and save to member variables so they can be used by plot():
    ...
    def print(self):  # must be _print to avoid collisions with Python builtin print
        pass
    ...
    def plot(self, pltype, *variables, **kwargs):
        ...
        if pltype.lower() == 'tran':  # If the plot type is transient. (TODO: other types)
            ...
            if notebook:
                ...
                for curve in curves:
                    x, y, label = curve
                    plt.plot(x, y, label=label)  # create a matplotlib plot
